...
var _backCreateStore = require('./back/createStore');

var _backCreateStore2 = _interopRequireDefault(_backCreateStore);

var _backConfig = require('./back/Config');

var _backConfig2 = _interopRequireDefault(_backConfig);

var _backSerialization = require('./back/Serialization');

var _backSerialization2 = _interopRequireDefault(_backSerialization);
...
module.exports = {
  ...
  Serialization: _backSerialization2['default'],
  createStore: _backCreateStore2['default'],
