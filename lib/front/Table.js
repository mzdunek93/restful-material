...
var Table = _react2["default"].createClass({
  ...
  thead: function thead() {
    return _react2["default"].createElement(
      "tr",
      null,
      _underscore2["default"].keys(this.props.spec).map(function (h, i) {
        return _react2["default"].createElement(
          "th",
          { key: i },
          h
  ...
  tbody: function tbody(resources) {
    ...
    if (resources) return this.resources(resources).map(function (r, i) {
      var row = [];
      Object.keys(_this.props.spec).map(function (title) {
        var val = _this.props.spec[title];
      ...
      _react2["default"].createElement(
        "td",
        { colSpan: Object.keys(this.props.spec).length },
  ...
  filters: function filters() {
    ...
    return _react2["default"].createElement(
      "tr",
      null,
      Object.keys(this.props.spec).map(function (title) {
        if (_underscore2["default"].isFunction(_this2.props.spec[title])) return _react2["default"].createElement("th", { "data-title": title });else return _react2["default"].createElement(
          "th",
          { "data-title": title },
